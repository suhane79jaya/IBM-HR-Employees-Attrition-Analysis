Introduction:HR Attrition Analysis
...
Objectives of the Analysis/Problem Statement
...
Study of factors like Age, Salary, Job Role, YearsAtCompany
Identification of high-risk attrition groups
Data from IBM HR dataset only
...
3. Data Cleaning:
   ...
   2. Check data Shape and data types
...
6. Attrition may be higher in the 28–35 age group (career transition phase)
